...
def test_check_designs_reads_selected_owner_target_catalog_once(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
''',
    ...
    component = write_component_owner(
        tmp_path,
        "example",
        filesets={"flow": ("ip/example/configs/flows/recipe.toml",)},
    )
    component.write_text(
