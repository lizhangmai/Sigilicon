...
class _ObservedClosure:
    ...
    closure: PlacementRoutingClosureEvidence | None
...
class ClosureCampaignRunner:
    ...
    def _observe(
        ...
        if closure is not None and closure.quality.closed and not result.closed:
            issues.append("closed closure evidence requires a closed Physical Design Result")
