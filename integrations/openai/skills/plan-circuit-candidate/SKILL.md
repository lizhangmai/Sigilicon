...
6. If exact canonical Candidate and stage artifacts already exist, call `candidate.validate`; bind any further discussion to the returned Candidate hash. Validation proves schema and lineage, not circuit performance.
