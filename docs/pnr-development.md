...
- typed layer, length-range, maximum-via, and multi-net skew Routing Constraints
  with structural validation, search-time layer/via/objective filtering, and
  independent result outcomes;
...
add topology/shielding and richer length-matching constraints, plus fine-grained
