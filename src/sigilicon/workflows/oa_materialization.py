...
def _render_oa_materialization_skill(
    job: PhysicalDesignJob,
...
def _render_oa_materialization_validation_skill(
    job: PhysicalDesignJob,
    result: PhysicalDesignResult,
    plan: MaterializationPlan,
    target: _OaTarget,
...
class OaXStreamMaterializationAdapter:
    ...
    def _execute_backend(
        ...
        *,
        ...
        write_source = _render_oa_materialization_skill(job, result, plan, assets)
        validate_source = _render_oa_materialization_validation_skill(
            job,
            result,
            plan,
            assets.target,
