...
## For hyper_route_opt
set ENABLE_ROUTE_OPT_PBA		true ;# true|false|""; RM default true; controls whether to enable PBA for hyper_route_opt;
                                        ;# true enables PBA path (sets time.pba_optimization_mode to path), false disables PBA (sets time.pba_optimization_mode to none), and "" (null) does not change current PBA setting
